        ...
        <div className="grid2x2">
            ...
            <div className="card">
                ...
                {items[0] && items[0].links && items[0].links.length > 0 
                    ? items[0].links.map(link => <div className="card-link"><a href={link.url} target="_blank" rel="noopener noreferrer">{link.text}</a></div>) 
                    : null }
            </div>
            <div  className="card">
                ...
                {items[1] && items[1].links && items[1].links.length > 1 
                    ? items[1].links.map(link => <div key={link.text} className="card-link"><a href={link.url} target="_blank" rel="noopener noreferrer">{link.text}</a></div>) 
                    : null }
                </div>
            </div>
            <div>
